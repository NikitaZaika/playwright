...
test('test', async ({ page }) => {
  ...
  await page.fill('text=Log in × Username: Password: Close Log in >> input[type="text"]', 'Zaika Nikita');

  await page.click('text=Log in × Username: Password: Close Log in >> input[type="password"]');

  await page.fill('text=Log in × Username: Password: Close Log in >> input[type="password"]', 'Zaika Nikita');
